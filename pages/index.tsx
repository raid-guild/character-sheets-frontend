...
export default function Home(): JSX.Element {
  return (
    <Flex
      ...
      px='10vw'
    >
      <Heading w='full' maxW='600px' size={{ base: "3xl", lg: "4xl" }} variant='noShadow'>Eternalize your journey</Heading>
      <Text w='full' maxW='630px' color="white" fontSize={{ base: "xl", lg: "2xl" }} mt="6">
        Build a character through your work as a web3 mercenary. Slay moloch,
        earn XP.
      </Text>
      <Flex direction={{ base: "column", lg: "row" }} mt='12'>
        <Button variant='solid' bg='primary.500' size='lg' mr={{ base: "0", lg: "15px" }} mt={{ base: "10px", lg: "0" }} as={NextLink} href="/all-games">Browse games</Button>
